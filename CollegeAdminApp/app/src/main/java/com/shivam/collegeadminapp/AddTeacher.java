package com.shivam.collegeadminapp;
...
import com.shivam.collegeadminapp.R;
...
public class AddTeacher extends AppCompatActivity {
    ...
    private String name,post,email,downloadUrl="";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] items=new String[]{"Select Category","Btech Computer Science","Btech Mechanical","Btech Civil","Physics","Chemistry"};
    ...
    private void insertData() {
        ...
        dbRef.child(uniqueKey).setValue(teacherData).addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onFailure(@NonNull Exception e) {
                pd.dismiss();
                Toast.makeText(AddTeacher.this,"Smoething went wrong",Toast.LENGTH_SHORT).show();
            }
        });
